...
extension TerminalNSView {
    // MARK: - Drag and Drop (Finder file drops)
    ...
    override func performDragOperation(_ sender: NSDraggingInfo) -> Bool {
        ...
        // Insert the dropped paths as text at the cursor, quoted for the shell,
        // without executing — matching Terminal.app/iTerm2 drop behavior.
